...
(`../5-cikti-kodlari-ve-rapor/tur-B-donatimli/`) gerçek `Code.gs` + `Stylesheet.html` + `JavaScript.html`
...
> Veri kaynağı: `../4-veri/veri.csv` (228 kayıt, S6 sütun yapısı:
...
| Çıktı | `../5-cikti-kodlari-ve-rapor/tur-A-donatimsiz/` | `../5-cikti-kodlari-ve-rapor/tur-B-donatimli/` |
...
| Transcript | `tur-A.md` | `tur-B.md` |

**Tur A çıktısı:**

![Tur A](../3-ekran-goruntuleri/turA-cikti.png)

**Tur B çıktısı (E1 ekranı):**

![Tur B E1](../3-ekran-goruntuleri/turB-E1-ozet-kpi.png)
...
| Render #1 | Render #2 |
| :--: | :--: |
| ![r1](../3-ekran-goruntuleri/senaryo1-render1.png) | ![r2](../3-ekran-goruntuleri/senaryo1-render2.png) |
...
![Boş veri](../3-ekran-goruntuleri/senaryo2-bos-veri.png)
...
**Kod düzeyinde kanıt:** Üretilen `../5-cikti-kodlari-ve-rapor/tur-B-donatimli/Code.gs` veriyi içermez; tek
...
| :--: | :--: |
| ![E2](../3-ekran-goruntuleri/turB-E2-trend.png) | ![E3](../3-ekran-goruntuleri/turB-E3-pareto.png) |

E4 — Detay tablosu (TR sayı formatı `1.250,50`):

![E4](../3-ekran-goruntuleri/turB-E4-detay.png)
...
| Önce | Sonra |
| :--: | :--: |
| ![önce](../3-ekran-goruntuleri/senaryo5-canli-once.png) | ![sonra](../3-ekran-goruntuleri/senaryo5-canli-sonra.png) |
...
**6/6 senaryo geçti.** Kanıt görüntüleri `../3-ekran-goruntuleri/` klasöründedir.
