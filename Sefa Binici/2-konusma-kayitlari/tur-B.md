...
**Okunan standartlar:** `../1-kurallar-ve-standart/kalici-kurallar.md`,
`../1-kurallar-ve-standart/uretim-standardi.md`, `../1-kurallar-ve-standart/skill-dashboard-architecture.md`,
`../1-kurallar-ve-standart/hook-deployment.md`, `../1-kurallar-ve-standart/renk.md`

**Çıktı:** `../5-cikti-kodlari-ve-rapor/tur-B-donatimli/` (`Code.gs`, `Index.html`, `Stylesheet.html`,
`JavaScript.html`, `DEPLOYMENT.md`)
**Ekran görüntüleri:** `../3-ekran-goruntuleri/turB-E1…E4-*.png`
...
çalışmaya kurumsal kimlik kazandırıldı (bkz. `../3-ekran-goruntuleri/turB-E1-ozet-kpi.png`).
